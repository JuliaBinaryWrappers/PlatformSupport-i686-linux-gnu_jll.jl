module PlatformSupport-i686-linux-gnu_jll
...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import PlatformSupport-i686-linux-gnu_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("48bcb9a0-0529-5ae1-8077-aeab58d09de5"))
platforms = [Pkg.Artifacts.unpack_platform(e, "PlatformSupport-i686-linux-gnu", artifacts_toml) for e in artifacts["PlatformSupport-i686-linux-gnu"]]
...
if best_platform === nothing
    @debug("Unable to load PlatformSupport-i686-linux-gnu; unsupported platform $(triplet(platform_key_abi()))")
else
    # Load the appropriate wrapper
    include(joinpath(@__DIR__, "wrappers", "$(best_platform).jl"))
end

end  # module PlatformSupport-i686-linux-gnu_jll
